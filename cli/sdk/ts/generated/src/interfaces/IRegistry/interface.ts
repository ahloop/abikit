// Auto-generated interface wrapper for IRegistry
...
export class IRegistry {
   ...
   * view
   */
  async getAgent(agentId: Hash): Promise<[Hash, Hash, string, string, string, boolean]> {
    if (!this.publicClient) throw new Error('Public client required for read operations');
    return await readContract(this.publicClient, {
      address: this.address,
      abi: IREGISTRY_ABI,
   ...
   * view
   */
  async isAgentRegistered(agentId: Hash): Promise<boolean> {
    if (!this.publicClient) throw new Error('Public client required for read operations');
    return await readContract(this.publicClient, {
      address: this.address,
      abi: IREGISTRY_ABI,
  ...
  async getAgentOwnershipTransferredLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'AgentOwnershipTransferred'),
  ...
  async getAgentRatingCountUpdatedLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'AgentRatingCountUpdated'),
      fromBlock: options?.fromBlock ?? 0n,
      toBlock: options?.toBlock ?? 'latest',
  ...
  async getAgentRegisteredLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'AgentRegistered'),
      fromBlock: options?.fromBlock ?? 0n,
      toBlock: options?.toBlock ?? 'latest',
  ...
  async getAttestationRootEnabledLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'AttestationRootEnabled'),
      fromBlock: options?.fromBlock ?? 0n,
      toBlock: options?.toBlock ?? 'latest',
  ...
  async getAttestationVerifiedLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'AttestationVerified'),
      fromBlock: options?.fromBlock ?? 0n,
      toBlock: options?.toBlock ?? 'latest',
  ...
  async getNetworkSetLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'NetworkSet'),
      fromBlock: options?.fromBlock ?? 0n,
      toBlock: options?.toBlock ?? 'latest',
  ...
  async getRatingSubmittedLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'RatingSubmitted'),
      fromBlock: options?.fromBlock ?? 0n,
      toBlock: options?.toBlock ?? 'latest',
  ...
  async getReputationProviderSetLogs(options?: {
    ...
    return await this.publicClient.getLogs({
      address: this.address,
      event: IREGISTRY_ABI.find(e => e.type === 'event' && e.name === 'ReputationProviderSet'),
      fromBlock: options?.fromBlock ?? 0n,
      toBlock: options?.toBlock ?? 'latest',
      args: { agentId: options?.agentId }
    }) as any[];
