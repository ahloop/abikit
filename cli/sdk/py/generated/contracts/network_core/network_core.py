...
class NetworkCore:
    ...
    def agent_manager(self):
        """agentManager"""
        return self.contract.functions.agentManager().call()

    def attestation_manager(self):
        """attestationManager"""
        return self.contract.functions.attestationManager().call()
    ...
    def bid_manager(self):
        """bidManager"""
        return self.contract.functions.bidManager().call()
    ...
    def modules_initialized(self):
        """modulesInitialized"""
        return self.contract.functions.modulesInitialized().call()
    ...
    def reputation_manager(self):
        """reputationManager"""
        return self.contract.functions.reputationManager().call()
    ...
    def settlement_manager(self):
        """settlementManager"""
        return self.contract.functions.settlementManager().call()
