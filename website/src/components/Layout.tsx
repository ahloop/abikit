                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="flex justify-between items-center h-20">
                            ...
                            <div className="nav-links flex gap-6 items-center">
                                ...
                                <a href="https://www.npmjs.com/package/abikit" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900 transition-colors" aria-label="npm Package">
